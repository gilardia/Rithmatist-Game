...
namespace Rithmatist.Networking
{
    public class Client
    {
        ...
        {
            readBuffer = new byte[Rithmatist.Properties.Rithmatist.Default.ReadBufferSize];
            this.id = id;
            this.client = client;
        ...
        {
            client.GetStream().BeginRead(readBuffer, 0, Rithmatist.Properties.Rithmatist.Default.ReadBufferSize, StreamReceived, null);
        }
